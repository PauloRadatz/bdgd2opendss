...
def convert_ptratio(case): #adicionado por Mozart dia 28/06 às 10:33h
    switch_dict = {
        '0' : 120,
        '1' : 138000/(np.sqrt(3)*115),
        '18': 92000/(np.sqrt(3)*115),
        '2' : 69000/(np.sqrt(3)*115),
        '19': 34500/115,
        '3' : 34500/(np.sqrt(3)*115),
        '25': 25000/115,
        '4' : 25000/(np.sqrt(3)*115),
        '21': 23000/115,
        '6' : 23000/(np.sqrt(3)*115),
        '22': 14400/115,
        '10': 14400/(np.sqrt(3)*115),
        '23': 13800/115,
        '15': 13800/(np.sqrt(3)*115),
        '24': 7600/115,
        '17' : 7600/(np.sqrt(3)*115)
    }
    return switch_dict.get(case, 'Invalid case')
