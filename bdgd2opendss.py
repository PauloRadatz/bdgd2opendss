...
if __name__ == '__main__':
    ...
    # DEBUG ONLY
    # bdgdPath = "CPFL_Paulista_63_2023-12-31_V11_20240508.gdb"
    # alimentador = "ABR07"
    ...
    # EXAMPLE
    # par = Parameters(bdgdPath, alimentador, False, True, True,  False, "ANEEL", "asBDGD", "generator")
