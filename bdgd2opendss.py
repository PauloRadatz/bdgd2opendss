...
<<<<<<< Updated upstream:bdgd2opendss.py
...
=======
    bdgd_file_path = pathlib.Path(script_path, "bdgd2opendss", "sample", "raw", "aneel", r"C:\Users\mozar\OneDrive\Desktop\RRE_BDGD\BDGD_RRE_V5")
    lst_feeders = ['CE_AL2-07']#lista
    pastadesaida = r"C:\Users\mozar\OneDrive\Desktop\RRE_BDGD"
    path_coords = r"C:\Users\mozar\OneDrive\Desktop\buscoords_1_3PAS_1.csv"
    # You can change setting below if needed
...
=======
    ...
    #bdgd.run(bdgd_file_path=bdgd_file_path,all_feeders=False, lst_feeders=lst_feeders, output_folder=pastadesaida)
    bdgd.verificacao_bdgd(bdgd_file_path=bdgd_file_path,all_feeders=False,lst_feeders=lst_feeders,output_folder=pastadesaida,path_coords=path_coords)
