...
if __name__ == '__main__':
    ...
    pastadesaida = r"C:\Users\mozar\OneDrive\Desktop\COPREL"
    ...
    bdgd.run(bdgd_file_path=bdgd_file_path,all_feeders=False, output_folder=pastadesaida,lst_feeders=lst_feeders)
